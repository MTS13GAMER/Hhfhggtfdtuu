...
function CheckQuest() 
    ...
    if World1 then
        ...
        elseif MyLevel == 15 or MyLevel <= 29 thenKEY_91d328c64538a78ac5cc
            Mon = "Gorilla"
            LevelQuest = 2
            NameQuest = "JungleQuest"
            NameMon = "Gorilla"
...
local Window = OrionLib:MakeWindow({Name = "BoxBuh Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Sla Hub"})
